...
export type AcpSessionEvent =
  ...
  | { type: "requestPermission"; params: schema.RequestPermissionRequest }
  | { type: "requestPermissionError"; error: string }
  | { type: "promptComplete"; response: schema.PromptResponse }
