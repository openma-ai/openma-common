...
import { parseAcpEvent as parseCommonAcpEvent, sessionUpdateInner, sessionUpdateType, } from "../../session-events/acp.js";
...
function adapterMeta(value) {
    return isRecord(value._meta) ? { ...value._meta } : undefined;
}
function messagePhase(value) {
    if (!isRecord(value._meta) || !isRecord(value._meta.codex))
        return undefined;
...
function isAcpContentBlock(value) {
    ...
    const rawMessageText = typeof contentRecord?.text === "string"
        ...
        : typeof inner.content === "string"
            ...
            : typeof inner.text === "string"
                ? inner.text
                : undefined;
    if ((wireType === "agent_message_chunk" || wireType === "agent.message_chunk")
        && rawMessageText) {
...
export function decodeAcpAgentRequest(request, context) {
...
export function decodeAcpAgentNotification(notification, context) {
    if (notification.method === "session/update") {
        ...
        return decodeAcpSessionNotification(params, context);
    }
    return {
        fidelity: "exact",
        diagnostics: [],
...
export function decodeAcpClientResponse(response, context) {
...
export function decodeAcpAgentResponse(response, context) {
...
export function encodeAcpInput(event, context = {}) {
...
export function decodeAcpSessionNotification(notification, context) {
 ...
 */
export function decodeAcpSessionUpdate(sessionId, input, context) {
